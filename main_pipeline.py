...
table_spec = (
    'ambient-stack-437506-p6:'
    'pimpat_workshop2.pimpat_dfsqltable_sales'
)
...
pipeline_args = [
    '--project=ambient-stack-437506-p6',  # Change to your GCP project ID
    '--runner=DataflowRunner',
    '--region=us-central1',  # Adjust as per your GCP region
    '--staging_location=gs://pimpat_workshop2/temp/staging/',  # Change to your bucket path
    '--temp_location=gs://pimpat_workshop2/temp',  # Change to your bucket path
    '--streaming',
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/ambient-stack-437506-p6/topics/pimpat-transactions"  # Change to your PubSub topic
 )
